...
var extractHostname = function extractHostname(full_url) {
  try {
    return new URL(full_url.html).hostname;
  } catch (error) {
    return null;
  }
};
var extractOrigin = function extractOrigin(full_url) {
  try {
    var _URL;
    return (_URL = new URL(full_url.html)) == null ? void 0 : _URL.origin;
  } catch (error) {
    return null;
  }
};
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          src = '../../trackings.nemu.com.br/trackings/script.js';
          /* javascript-obfuscator:disable */
        ...
        case 8:
          ...
          baseURL = (_URL2 = new URL(src.html)) == null ? void 0 : _URL2.origin;
          if (baseURL) {
            _context9.next = 14;
            break;
          }
